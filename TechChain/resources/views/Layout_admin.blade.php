...
<head>
  ...
  <title>@yield('title') | Admin Broad of TechChain</title>
  ...
  <div class="d-flex min-vh-100">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-primary" style="max-width: 280px;" data-bs-theme="dark">
      ...
      <ul class="nav nav-pills flex-column mb-auto" data-bs-themes>
        <li class="nav-item">
          <a href="dashboard.html" class="nav-link rounded-0 active" aria-current="page">
        ...
        <li>
          <a href="products.html" class="nav-link rounded-0 text-white">
